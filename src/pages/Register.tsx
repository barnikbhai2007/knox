...
import { ChevronRight, CheckCircle2, ShieldAlert, Upload } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-fc-dark flex flex-col items-center justify-center p-6 text-center">
         ...
         >
           ...
           <h2 className="font-display uppercase text-2xl font-bold tracking-wider text-fc-green mb-4">Registration Sent</h2>
    ...
    <div className="min-h-screen bg-fc-dark text-white p-6 pb-20">
      <div className="max-w-2xl mx-auto">
        <header className="mb-10 text-center pt-8">
          <h1 className="font-display uppercase text-3xl font-bold tracking-wider text-fc-green mb-2">Player Registration</h1>
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-6">
          <div className="bg-fc-card p-6 rounded-2xl border border-white/5 space-y-4">
            <h3 className="font-display uppercase text-xl font-bold tracking-wider text-fc-green">Personal Details</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className="block">
                <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold ml-1 mb-1 block">Full Name</span>
                <input type="text" name="name" value={formData.name} onChange={handleChange} className={cn("w-full bg-black border rounded-xl px-4 py-3 placeholder:text-gray-600 focus:outline-none transition-colors text-white", submitted && !formData.name ? "border-red-500" : "border-white/10 focus:border-fc-green")} placeholder="John Doe" />
              </label>
              <label className="block">
                <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold ml-1 mb-1 block">Age</span>
                <input type="number" name="age" value={formData.age} onChange={handleChange} className={cn("w-full bg-black border rounded-xl px-4 py-3 placeholder:text-gray-600 focus:outline-none transition-colors text-white", submitted && !formData.age ? "border-red-500" : "border-white/10 focus:border-fc-green")} placeholder="18" />
              </label>
            </div>
            
            <label className="block">
              <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold ml-1 mb-1 block">Mobile Number</span>
              <input type="tel" name="mobile" value={formData.mobile} onChange={handleChange} className={cn("w-full bg-black border rounded-xl px-4 py-3 placeholder:text-gray-600 focus:outline-none transition-colors text-white", submitted && !formData.mobile ? "border-red-500" : "border-white/10 focus:border-fc-green")} placeholder="+1 234 567 8900" />
            </label>
          </div>

          <div className="bg-fc-card p-6 rounded-2xl border border-white/5 space-y-4">
            <h3 className="font-display uppercase text-xl font-bold tracking-wider text-fc-green">KnoX11 Profile</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className="block">
                <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold ml-1 mb-1 block">In-Game Name</span>
                <input type="text" name="fcName" value={formData.fcName} onChange={handleChange} className={cn("w-full bg-black border rounded-xl px-4 py-3 placeholder:text-gray-600 focus:outline-none transition-colors text-white", submitted && !formData.fcName ? "border-red-500" : "border-white/10 focus:border-fc-green")} placeholder="xX_Striker_Xx" />
              </label>
              <label className="block">
                <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold ml-1 mb-1 block">Player UID</span>
                <input type="text" name="fcUid" value={formData.fcUid} onChange={handleChange} className={cn("w-full bg-black border rounded-xl px-4 py-3 placeholder:text-gray-600 focus:outline-none transition-colors text-white", submitted && !formData.fcUid ? "border-red-500" : "border-white/10 focus:border-fc-green")} placeholder="123456789" />
              </label>
              <label className="block">
                <span className="text-xs text-gray-400 uppercase tracking-wider font-semibold ml-1 mb-1 block">Team OVR</span>
                <input type="number" name="fcOvr" value={formData.fcOvr} onChange={handleChange} className={cn("w-full bg-black border rounded-xl px-4 py-3 placeholder:text-gray-600 focus:outline-none transition-colors text-white", submitted && !formData.fcOvr ? "border-red-500" : "border-white/10 focus:border-fc-green")} placeholder="95" />
              </label>
              <label className="block">
